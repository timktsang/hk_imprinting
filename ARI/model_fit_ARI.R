...
load('ARI_new/CIs_1.RData')
load('ARI_new/model_fits_add_Vac2.RData')
# source('program/population_likelihood.R')
plot1 = 'ARI_new/aHAGroupfit3.pdf'
plot2 = 'ARI_new/aHASubfit_1.pdf'
plot3 = 'ARI_new/aNAfit.tiff'
plot4 = 'ARI_new/aNonefit.tiff'
plot5 = 'ARI_new/aFig1.tiff'
plot6 = 'ARI_new/vaccination_coverage.pdf'
...
# pdf(file = plot1, width = 10, height = 3.5)
# plot_fuc(gob,gpre)
# dev.off()
...
write.csv(observed,'/Users/yifanwang/Desktop/materials/HKU_RA/imprinting/ARI_new/observed_1.csv')
write.csv(predicted,'/Users/yifanwang/Desktop/materials/HKU_RA/imprinting/ARI_new/predicted_1.csv')

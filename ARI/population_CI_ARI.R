...
load('ARI_new/model_fits_add_Vac2.RData') # Model fits saved as lk.A, lk.AG, lk.AS, lk.AN
# source('program/population_likelihood.R')
library('parallel')

## OUTPUTS
outfile1 = 'ARI_new/profiles.RData'
outfile1_2 = 'ARI_new/profiles_1.RData'

outfile2 = 'ARI_new/CIs.RData'
outfile2_2 = 'ARI_new/CIs_1.RData'
...
# ## Test
one_prof_point(par.in = lk2.NA$par, fixpar = 'r5.24', fixed.par.value = .5, lows = c(rep(.001, length(lk.NA$par)-1),0.499), highs = c(1,1, rep(5, 4),0.5), H1.protection.input = prog1.master_2009, H3.protection.input = prog2.master_2009,vac=vac2)
...
load('ARI_new/profiles.RData')
save(HAGroup.age.prof2, HASub.age.prof2, NA.age.prof2, HAGroup.imp.prof2, HASub.imp.prof2, NA.imp.prof2, HAGroup.vac.prof2, HASub.vac.prof2,NA.vac.prof2,None.vac.prof2,file = outfile1_2)
load('ARI_new/profiles_1.RData')
...
write.csv(est2,'/Users/yifanwang/Desktop/materials/HKU_RA/imprinting/ARI_new/model_est_and_vac_1.csv')

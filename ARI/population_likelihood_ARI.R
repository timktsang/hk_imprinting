...
write.csv(population_distribution,'/Users/yifanwang/Desktop/materials/HKU_RA/imprinting/ARI_new/populationdistribution.csv')
nll = function(pars,
               wPro.H1,
               dat.H1,
               wPro.H3,
...
write.csv(AICs,'/Users/yifanwang/Desktop/materials/HKU_RA/imprinting/ARI_new/AICs.csv')
modelfits2 = '/Users/yifanwang/Desktop/materials/HKU_RA/imprinting/ARI_new/model_fits_add_Vac2.RData'
save(AICs, lk2.HAGroup, lk2.HASub, lk2.NA, lk2.None, file = modelfits2)

write.csv(H1.master_2009_1,'/Users/yifanwang/Desktop/materials/HKU_RA/imprinting/ARI_new/PCR-H1N1_1.csv')
write.csv(H3.master_2009_1,'/Users/yifanwang/Desktop/materials/HKU_RA/imprinting/ARI_new/PCR-H3N2_1.csv')

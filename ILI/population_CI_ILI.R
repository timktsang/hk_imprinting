...
load('ILI_new/model_fits_add_Vac2.RData') # Model fits saved as lk.A, lk.AG, lk.AS, lk.AN
# source('program/population_likelihood.R')
library('parallel')

## OUTPUTS
outfile1 = 'ILI_new/profiles.RData'
outfile1_2 = 'ILI_new/profiles_1.RData'

outfile2 = 'ILI_new/CIs.RData'
outfile2_2 = 'ILI_new/CIs_1.RData'
...
write.csv(est2,'/Users/yifanwang/Desktop/materials/HKU_RA/imprinting/ILI_new/model_est_and_vac_1.csv')

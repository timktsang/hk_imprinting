...
load('raw_new/CIs_1.RData')
load('raw_new/model_fits_add_Vac2.RData')
# source('program/population_likelihood.R')
plot1 = 'raw_new/aHAGroupfit3.pdf'
plot2 = 'raw_new/aHASubfit_1.pdf'
plot3 = 'raw_new/aNAfit.tiff'
plot4 = 'raw_new/aNonefit.tiff'
plot5 = 'raw_new/aFig1.tiff'
plot6 = 'raw_new/vaccination_coverage.pdf'
...
write.csv(observed,'/Users/yifanwang/Desktop/materials/HKU_RA/imprinting/raw_new/observed_1.csv')
write.csv(predicted,'/Users/yifanwang/Desktop/materials/HKU_RA/imprinting/raw_new/predicted_1.csv')
